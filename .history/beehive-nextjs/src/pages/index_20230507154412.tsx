...
export const metadata: Metadata = {
  title: 'Early childhood Relief teachers | Beehive',
  description:
    'Beehive joins early childcare relief teachers with early childcare centres.',
}
  ...
  return (
    ...
    >
      <div className=" flex flex-col items-center mt-40 sm:mt-32 w-4/5 mx-auto md:items-start">
        ...
        >
          Beehive makes it easy and fast to connect ECE teachers with childcare centres.<br/>
